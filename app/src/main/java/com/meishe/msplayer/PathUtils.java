...
public class PathUtils {
    ...
    private static String SDK_FILE_ROOT_DIRECTORY = "ms_player" + File.separator;

    private static String ENCODE_DIRECTORY = SDK_FILE_ROOT_DIRECTORY + "encode";
    ...
    public static String getEncodeDir() {
        return getFolderDirPath(ENCODE_DIRECTORY);
    }
